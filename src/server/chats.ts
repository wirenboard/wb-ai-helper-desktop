...
- **Если нет нужного скилла и нет уверенности в деталях** (путь файла, имя RPC-метода, формат конфига) — спроси пользователя или сходи в документацию. Не угадывай и не пробуй наугад.
